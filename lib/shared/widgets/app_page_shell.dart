      ...
      builder: (context, constraints) {
        ...
        return Scaffold(
          ...
          body: SafeArea(
            child: Row(
              children: [
                if (isDesktop) _SideNavigation(currentRoute: currentRoute),
                Expanded(
                  child: Column(
                    children: [
                      _TopBar(
          ...
          bottomNavigationBar: isDesktop
              ? null
              : _BottomNavigation(currentRoute: currentRoute),
        );
      },
    );
  }
...
class _BottomNavigation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return NavigationBar(
      selectedIndex: _navItems.indexWhere((item) => item.route == currentRoute),
